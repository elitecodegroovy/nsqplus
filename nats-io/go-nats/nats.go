...
import (
	...
	"github.com/elitecodegroovy/nsqplus/nats-io/go-nats/util"
	"github.com/elitecodegroovy/nsqplus/nats-io/nuid"
)

// Default Constants
//nats-route://10.50.115.17:8248
//nats-route://10.50.115.16:8248

const (
	Version                 = "1.3.1"
	//DefaultURL              = "nats://10.50.115.18:8222,nats://10.50.115.17:8222,nats://10.50.115.16:8222"
	DefaultURL              = "nats://10.50.115.16:8222"
	DefaultPort             = 8222
...
func (nc *Conn) addURLToPool(sURL string, implicit bool) error {
	...
	nc.urls[u.Host] = struct{}{}                                                                                        //TODO >>> VIP
	return nil
}
