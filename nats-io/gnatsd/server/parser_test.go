...
//Parser grammar definition test
...
func TestParseMsgSpace(t *testing.T) {
	...
	// Ivan bug he found, correct format 'MSG \t\n'
	...
	// Anything with an M from a client should parse error, typ='Client'
...
//Test parser OP_START switch case
