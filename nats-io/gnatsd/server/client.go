...
//read the producer client data and flush.
//manage the allocation memory with method 'bufio.NewWriterSize'.
func (c *client) readLoop() {
	...
	for {
		...
		// from parsing through the buffer. AddInt64 atomically adds delta to *addr and returns the new value.
...
// TODO ...think in protocol [VIP] Assume the lock is held upon entry.
