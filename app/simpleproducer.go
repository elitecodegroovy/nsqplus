...
import (
	"io/ioutil"
	"log"
	"github.com/elitecodegroovy/nsqplus/nsq" //default ,you should import the package full path 'github.com/bitly/go-nsq' with the command `go get github.com/bitly/go-nsq`
	//"strconv"
	//	"strconv"
)
